...
class statement_visitor_c: public iterator_visitor_c
{
public:
    statement_visitor_c(){}
    ~statement_visitor_c(){}
...
void *visit(assignment_statement_c *symbol, Node &_node);
...
void *visit(return_statement_c *symbol, Node &_node);
...
void *visit(fb_invocation_c *symbol, Node &_node);
...
void *visit(if_statement_c *symbol, Node &_node);
...
void *visit(case_statement_c *symbol, Node &_node);
