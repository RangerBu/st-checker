...
//#define WPDS_BUILDER_TEST
#ifdef WPDS_BUILDER_TEST
...
void doReach()
{
  ...
  std::ofstream fxml( "test/model-builder/wpds-examples/myWpds.xml" );
  ...
  std::ofstream fdot( "test/model-builder/wpds-examples/myWpds.dot" );
  answer.print_dot(fdot);
  fdot.close();
